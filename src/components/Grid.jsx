    ...
    return (
        ...
        <div className="tictactoeGame">
            <div className="tictactoeGrid">
                <div className="line">
                    <div className={`case ${winner !== 1 && (winningCases.indexOf(1) !== -1 ? 'winningCase' : 'opacity')}`} id="case1" onClick={(selectedCase.indexOf(1) === -1 && winner === 1 && howPlays) ? () => handleCase(1) : null}>{yourSelectedCase.includes(1) ? <FontAwesomeIcon icon={faStar} className='faIcon' /> : comSelectedCase.includes(1) ? <FontAwesomeIcon icon={faCloud} className='faIcon faIcon--computer' /> : ''}</div>
                    <div className={`case ${winner !== 1 && (winningCases.indexOf(2) !== -1 ? 'winningCase' : 'opacity')}`} id="case2" onClick={(selectedCase.indexOf(2) === -1 && winner === 1 && howPlays) ? () => handleCase(2) : null}>{yourSelectedCase.includes(2) ? <FontAwesomeIcon icon={faStar} className='faIcon' /> : comSelectedCase.includes(2) ? <FontAwesomeIcon icon={faCloud} className='faIcon faIcon--computer' /> : ''}</div>
                    <div className={`case ${winner !== 1 && (winningCases.indexOf(3) !== -1 ? 'winningCase' : 'opacity')}`} id="case3" onClick={(selectedCase.indexOf(3) === -1 && winner === 1 && howPlays) ? () => handleCase(3) : null}>{yourSelectedCase.includes(3) ? <FontAwesomeIcon icon={faStar} className='faIcon' /> : comSelectedCase.includes(3) ? <FontAwesomeIcon icon={faCloud} className='faIcon faIcon--computer' /> : ''}</div>
                </div>
                <div className="line">
                    <div className={`case ${winner !== 1 && (winningCases.indexOf(4) !== -1 ? 'winningCase' : 'opacity')}`} id="case4" onClick={(selectedCase.indexOf(4) === -1 && winner === 1 && howPlays) ? () => handleCase(4) : null}>{yourSelectedCase.includes(4) ? <FontAwesomeIcon icon={faStar} className='faIcon' /> : comSelectedCase.includes(4) ? <FontAwesomeIcon icon={faCloud} className='faIcon faIcon--computer' /> : ''}</div>
                    <div className={`case ${winner !== 1 && (winningCases.indexOf(5) !== -1 ? 'winningCase' : 'opacity')}`} id="case5" onClick={(selectedCase.indexOf(5) === -1 && winner === 1 && howPlays) ? () => handleCase(5) : null}>{yourSelectedCase.includes(5) ? <FontAwesomeIcon icon={faStar} className='faIcon' /> : comSelectedCase.includes(5) ? <FontAwesomeIcon icon={faCloud} className='faIcon faIcon--computer' /> : ''}</div>
                    <div className={`case ${winner !== 1 && (winningCases.indexOf(6) !== -1 ? 'winningCase' : 'opacity')}`} id="case6" onClick={(selectedCase.indexOf(6) === -1 && winner === 1 && howPlays) ? () => handleCase(6) : null}>{yourSelectedCase.includes(6) ? <FontAwesomeIcon icon={faStar} className='faIcon' /> : comSelectedCase.includes(6) ? <FontAwesomeIcon icon={faCloud} className='faIcon faIcon--computer' /> : ''}</div>
                </div>
                <div className="line">
                    <div className={`case ${winner !== 1 && (winningCases.indexOf(7) !== -1 ? 'winningCase' : 'opacity')}`} id="case7" onClick={(selectedCase.indexOf(7) === -1 && winner === 1 && howPlays) ? () => handleCase(7) : null}>{yourSelectedCase.includes(7) ? <FontAwesomeIcon icon={faStar} className='faIcon' /> : comSelectedCase.includes(7) ? <FontAwesomeIcon icon={faCloud} className='faIcon faIcon--computer' /> : ''}</div>
                    <div className={`case ${winner !== 1 && (winningCases.indexOf(8) !== -1 ? 'winningCase' : 'opacity')}`} id="case8" onClick={(selectedCase.indexOf(8) === -1 && winner === 1 && howPlays) ? () => handleCase(8) : null}>{yourSelectedCase.includes(8) ? <FontAwesomeIcon icon={faStar} className='faIcon' /> : comSelectedCase.includes(8) ? <FontAwesomeIcon icon={faCloud} className='faIcon faIcon--computer' /> : ''}</div>
                    <div className={`case ${winner !== 1 && (winningCases.indexOf(9) !== -1 ? 'winningCase' : 'opacity')}`} id="case9" onClick={(selectedCase.indexOf(9) === -1 && winner === 1 && howPlays) ? () => handleCase(9) : null}>{yourSelectedCase.includes(9) ? <FontAwesomeIcon icon={faStar} className='faIcon' /> : comSelectedCase.includes(9) ? <FontAwesomeIcon icon={faCloud} className='faIcon faIcon--computer' /> : ''}</div>
                </div>                
            </div>
            ...
            <div className="scoreboard">
                ...
                <div className="games"><span className="titleScore">Games : {games}</span><span className="currentScore">{winner === 2 ? 'YOU WIN' : winner === 3 ? 'YOU LOSE' : winner === 4 ? 'DRAW' : '...'}</span></div>
